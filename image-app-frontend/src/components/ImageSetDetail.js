...
const ImageSetDetail = () => {
    ...
    const fetchSet = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:8080/api/image-sets/${id}`,
          isAuthenticated
        ...
        setError("Failed to fetch image set details");
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) {
    return (
      <div className="text-center mt-5">
        ...
        <p className="mt-2">Loading image set details...</p>
      </div>
    );
  }
  ...
  console.log(
    "Date: " + set.createdAt + new Date(set.createdAt).toLocaleString()
  );
          ...
          <div className="d-flex justify-content-between align-items-start mb-4">
            <div>
              ...
              <div className="text-muted mb-3">
                ...
                Uploaded by: {set.uploadedBy?.displayName || "Unknown"}
              </div>
              ...
              <Card>
                ...
                <Card.Body>
                  <p>
                    ...
                    {set.locationName || "Not specified"}
                  </p>
                  <p>
                    <strong>Capacity:</strong> {set.capacity || "Not specified"}
                  </p>
                </Card.Body>
              </Card>
            </Col>
